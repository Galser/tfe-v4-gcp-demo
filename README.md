# tfe-v4-gcp-demo
TFE v4 GCP 1-node installation in production mode with external servics behind load-balancer with a vlaid certificate from Let's Encrypt

# Purpose
This repo contains all the code and instructions on how to install a TFE (Prod) version 4 with a Valid Certificate in an Googlce Cloud Computing Environment
...
# TODO
- [ ] create code for compute infrastructure
 - [ ] add DB deploy
